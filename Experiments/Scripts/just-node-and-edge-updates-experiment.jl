...
datasets::Vector{DATASET} = [aids, human, yeast, dblp]
...
graph_grouped_box_plot(experiment_params_list, x_type=dataset, y_type=estimate_error, ylims=[10e-15, 10e15], x_label="Proportion Updated", y_label="Relative Error 10^", grouping=proportion_updated, legend_pos=:outerright, filename="ve-update-error-color")
